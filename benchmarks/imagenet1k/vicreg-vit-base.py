"""VICReg pretraining on ImageNet-1K with ViT-Base.
...
Usage (defaults):
    python benchmarks/imagenet1k/vicreg-vit-base.py
...
train_dataset = build_hf_dataset("train", data_dir, vicreg_transform)
