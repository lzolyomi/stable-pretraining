"""SALT Stage 1 (MAE pretraining) on ImageNet-100 with ViT-Base.
...
Usage (defaults):
    python benchmarks/imagenet100/salt-stage1-vit-base.py
...
Environment variables:
    ...
    SALT_STAGE1_RUN_NAME                Base name for the run (default: salt-stage1)
